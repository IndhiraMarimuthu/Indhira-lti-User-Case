...
public class EntityMapper {
    ...
    public MovieEntity mapMovieModelToEntity(Movie movie){
        return dozerBeanMapper.map(movie,MovieEntity.class);
    }

    public List<Movie> mapMovieEntityToModel(List<MovieEntity> movieEntities){
        List<Movie> movieList = new ArrayList<>();
        for (MovieEntity mov:movieEntities) {
            movieList.add(dozerBeanMapper.map(mov, Movie.class));
        }
        return movieList;
    }
